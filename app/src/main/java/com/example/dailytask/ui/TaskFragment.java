...
public class TaskFragment extends Fragment implements TaskAdapter.OnTaskActionListener {
    ...
    private String currentFilter = "all"; // all | pending | done
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addEditLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fabAddTask.setOnClickListener(v ->
                addEditLauncher.launch(new Intent(requireContext(), AddTaskActivity.class)));
    ...
    private void loadTasks() {
        ...
        progressBar.setVisibility(allTasks.isEmpty() ? View.VISIBLE : View.GONE);
    ...
    private void applyFilter() {
        ...
        for (Task task : allTasks) {
            ...
            boolean matchQuery = currentQuery.isEmpty()
                    || (task.getTitle() != null && task.getTitle().toLowerCase().contains(currentQuery.toLowerCase()));
    ...
    private void deleteTask(Task task) {
        ApiClient.getApiService().deleteTask(task.getId()).enqueue(new Callback<ApiResponse<Object>>() {
            @Override
    ...
    public void onDoneClick(Task task) {
        ApiClient.getApiService().updateStatus(task.getId(), "done").enqueue(new Callback<ApiResponse<Task>>() {
            @Override
